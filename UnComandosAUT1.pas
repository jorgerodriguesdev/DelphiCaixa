...
procedure TAUTBematechMP_2032.AbrePorta;
var
  porta : integer;
begin
...
// fechar porta
procedure TAUTBematechMP_2032.FecharPorta;
begin
  FechaPorta;
end;

// Imprime Texto sem Formatação.
function TAUTBematechMP_2032.Imprime(Texto : string) : boolean;
begin
  result := true;
  while result do
  begin
...
procedure TAUTBematechMP_2032.ImprimeFormato(Texto : string);
begin
...
// Autentica Documento
procedure TAUTBematechMP_2032.Autentica(texto : string);
var
  retorno : integer;
begin
...
// Aciona Gaveta
procedure TAUTBematechMP_2032.AcionaGaveta;
begin
...
function TAUTBematechMP_2032.DocumentoInserido : boolean;
begin
...
// verifica impressora
function TAUTBematechMP_2032.VerificaImpressora : boolean;
begin
...
procedure TAUTBematechMP_2032.ImprimeDesenho;
{
                  DESENHO
